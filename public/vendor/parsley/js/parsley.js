...
! function (d) {
    ...
    h.prototype = {
        ...
        init: function (a, b) {
            ...
            this.isRequired = !1;
            this.constraints = [];
            "undefined" === typeof this.isRadioOrCheckbox && (this.isRadioOrCheckbox = !1, this.hash = this.generateHash(), this.errorClassHandler = this.options.errors.classHandler(a) || this.$element);
        ...
        needsValidation: function (a) {
            if (null !== this.isValid && this.val === a && this.validatedOnce) return !1;
            this.val = a;
        ...
        manageValidationResult: function () {
            ...
            this.isValid = a;
            return !0 === this.isValid ? (this.removeErrors(), this.errorClassHandler.removeClass(this.options.errorClass).addClass(this.options.successClass), this.options.listeners.onFieldSuccess(this.element, this.constraints, this), !0) : !1 === this.isValid ? (this.errorClassHandler.removeClass(this.options.successClass).addClass(this.options.errorClass), this.options.listeners.onFieldError(this.element, this.constraints, this), !1) : a
        },
    ...
    m.prototype = {
        ...
        initMultiple: function (a, b) {
            ...
            this.errorClassHandler = b.errors.classHandler(a) || this.$element.parent()
        },
        inherit: function (a,
        b) {
            var c = new h(a, b),
    ...
    j.prototype = {
        ...
        validate: function (a) {
            var b = !0;
            this.focusedField = !1;
            for (var c = 0; c < this.items.length; c++) if (!1 === this.items[c].validate() && (b = !1, !this.focusedField && "first" === this.options.focus || "last" === this.options.focus)) this.focusedField = this.items[c].$element;
    ...
    d.fn.parsley = function (a, b) {
        ...
        var f = d.extend(!0, {}, d.fn.parsley.defaults, "undefined" !== typeof window.ParsleyConfig ? window.ParsleyConfig : {}, a, this.data()),
            e = null;
        d(this).is("form") ? e = c(d(this), "parsleyForm") : d(this).is(f.inputs) && !d(this).is(f.excluded) && (e = c(d(this), !d(this).is("input[type=radio], input[type=checkbox]") ? "parsleyField" :
            "parsleyFieldMultiple"));
        return "function" === typeof b ? b() : e
    };
    d.fn.parsley.Constructor = j;
