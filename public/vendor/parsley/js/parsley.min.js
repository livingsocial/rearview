...
var m=function(a,b){this.initMultiple(a,b);this.inherit(a,b);this.init(a,b)};m.prototype={constructor:m,initMultiple:function(a,b){this.element=a;this.$element=d(a);this.hash=this.getName();this.isRadioOrCheckbox=!0;this.isRadio=this.$element.is("input[type=radio]");this.isCheckbox=this.$element.is("input[type=checkbox]");this.siblings='input[name="'+this.$element.attr("name")+'"]';this.$siblings=d(this.siblings);this.errorClassHandler=b.errors.classHandler(a)||this.$element.parent()},inherit:function(a,
b){var c=new h(a,b),d;for(d in c)"undefined"===typeof this[d]&&(this[d]=c[d])},getName:function(){return"parsley-"+this.$element.attr("name").replace(/(:|\.|\[|\])/g,"")},getVal:function(){if(this.isRadio)return d(this.siblings+":checked").val()||"";if(this.isCheckbox){var a=[];d(this.siblings+":checked").each(function(){a.push(d(this).val())});return a}}};var j=function(a,b){this.init("parsleyForm",a,b)};j.prototype={constructor:j,init:function(a,b,c){this.type=a;this.items=[];this.$element=d(b);
this.options=c;var f=this,e;this.$element.find(c.inputs).each(function(){e=d(this).parsley(c);null!==e&&f.items.push(e)});this.$element.on("submit."+this.type,!1,d.proxy(this.validate,this))},addListener:function(a){for(var b in a)if(/Field/.test(b))for(var c=0;c<this.items.length;c++)this.items[c].addListener(a);else this.options.listeners[b]=a[b]},validate:function(a){var b=!0;this.focusedField=!1;for(var c=0;c<this.items.length;c++)if(!1===this.items[c].validate()&&(b=!1,!this.focusedField&&"first"===
this.options.focus||"last"===this.options.focus))this.focusedField=this.items[c].$element;this.focusedField&&!b&&this.focusedField.focus();this.options.listeners.onFormSubmit(b,a,this);return b},removeErrors:function(){for(var a=0;a<this.items.length;a++)this.items[a].parsley("reset")},destroy:function(){for(var a=0;a<this.items.length;a++)this.items[a].destroy();this.$element.off("."+this.type).removeData(this.type)}};d.fn.parsley=function(a,b){function c(c,e){var g=d(c).data(e);if(!g){switch(e){case "parsleyForm":g=
new j(c,f);break;case "parsleyField":g=new h(c,f);break;case "parsleyFieldMultiple":g=new m(c,f);break;default:return}d(c).data(e,g)}return"string"===typeof a&&"function"===typeof g[a]?g[a](b):g}var f=d.extend(!0,{},d.fn.parsley.defaults,"undefined"!==typeof window.ParsleyConfig?window.ParsleyConfig:{},a,this.data()),e=null;d(this).is("form")?e=c(d(this),"parsleyForm"):d(this).is(f.inputs)&&!d(this).is(f.excluded)&&(e=c(d(this),!d(this).is("input[type=radio], input[type=checkbox]")?"parsleyField":
"parsleyFieldMultiple"));return"function"===typeof b?b():e};d.fn.parsley.Constructor=j;d.fn.parsley.defaults={inputs:"input, textarea, select",excluded:"input[type=hidden], :disabled",trigger:!1,focus:"first",validationMinlength:3,successClass:"parsley-success",errorClass:"parsley-error",errorMessage:!1,validators:{},messages:{},errors:{classHandler:function(){},container:function(){},errorsWrapper:"<ul></ul>",errorElem:"<li></li>"},listeners:{onFieldValidate:function(){return!1},onFormSubmit:function(){},
onFieldError:function(){},onFieldSuccess:function(){}}};d(window).on("load",function(){d('[data-validate="parsley"]').each(function(){d(this).parsley()})})}(window.jQuery||window.Zepto);