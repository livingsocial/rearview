...
(function($) {
    ...
    */
    ...
    $.extend(Timepicker.prototype, {
        ...
        */
        _updateDateTime: function(dp_inst, ls_now) {
            if(!ls_now) {
    ...
    */
    ...
    $.datepicker._gotoToday = function(id) {
        ...
        this._setTime(inst, now_utc, 'now');
    };
    ...
    */
    $.datepicker._setTime = function(inst, date, ls_now) {
        var tp_inst = this._get(inst, 'timepicker');
        if (tp_inst) {
            ...
            tp_inst._onTimeChange();
            if(ls_now) {
                tp_inst._updateDateTime(null, ls_now);
            } else {
                tp_inst._updateDateTime(inst);
            }
        }
